!(function () {
      ...
      function u() {
        ...
        v.container &&
          (v.container instanceof Object
            ...
            : ((d = (i = (E(v.container) ? v.container : document.querySelector(v.container)).getBoundingClientRect())
                .width),
              (a = i.height),
              (r = i.left),
              (m = i.top),
  ...
  $docsify.plugins = [].concat(function (e) {
    ...
    e.doneEach(function (e) {
      var t = (t = Array.apply(
        null,
        document.querySelectorAll('.markdown-section img:not(.emoji):not([data-no-zoom])')
      )).filter(function (e) {
