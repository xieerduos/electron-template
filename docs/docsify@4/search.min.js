    ...
    return (
      e.forEach(function (e, n) {
        if ('heading' === e.type && e.depth <= o) {
          ...
          if (
            (0 === n &&
              ((s = r.toURL(i)), (d[s] = {slug: s, title: '/' !== i ? i.slice(1) : 'Home Page', body: e.text || ''})),
            !s)
          )
            return;
          d[s]
  ...
  function c(e) {
    ...
    if (!e)
      return (
        ...
        (t.innerHTML = ''),
        void (o.hideOtherSidebarContent && (i && i.classList.remove('hide'), n && n.classList.remove('hide')))
      );
    var e = (function (e) {
        var n = [],
          t = [];
          ...
          !(function (e) {
            ...
            d &&
              (a.forEach(function (e) {
                var n,
                  t = new RegExp(p(y(e)).replace(/[|\\{}()[\]^$+*?.]/g, '\\$&'), 'gi'),
                  a = -1,
                  i = -1;
                (s = d ? p(y(d)) : d),
                  (c = l ? p(y(l)) : l),
